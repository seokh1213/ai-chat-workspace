...
- Schema migrations live under `projects/apps/trip-plan/backend/src/main/resources/db/migration`.
- Seed SQL lives under `projects/apps/trip-plan/backend/src/main/resources/db/seed`.
...
```text
projects/apps/trip-plan/backend/src/main/resources/db/migration/
...
- Importing local-only legacy data files inside the new app runtime
